...
function UserDetails(user) {
  // the parameter `user` is actually the `props` object
  ...
  return (
    <div>
      ...
      { user.info.name && <li className="list-group-item">
        Name: { user.info.name }
      </li> }
      ...
      { user.info.location && <li className="list-group-item">
        Location: { user.info.location }
      </li> }

      { user.info.company && <li className="list-group-item">
      ...
      { user.info.blog && <li className="list-group-item">
